...
\begin{itemize}
    ...
    \item \texttt{purchase\_{}orders.csv}: Purchase order data (delivery date, product ID, quantity)
    \item \texttt{materials.csv}: Product-to-raw-material mapping (handles product splitting)
    \item \texttt{prediction\_{}mapping.csv}: Target prediction dates for submission
\end{itemize}
